        ...
        <Card className="shadow-2xl">
          ...
          <CardContent className="p-6">
            <div className="flex items-baseline gap-3 mb-4">
              ...
              <span className="text-lg text-gray-500 line-through">{formatCurrency(1000)}</span>
      ...
      <div className="hidden lg:block fixed right-8 top-24 w-96 z-50">
        <Card className="shadow-2xl">
          ...
          <CardContent className="p-6">
            ...
            <Button
              className="w-full mb-2 bg-purple-600 hover:bg-purple-700 text-white text-lg py-6"
              onClick={() =>
                addItemToCart({
                  id: course.id,
                  imageSrc: imageSrc,
