              ...
              <AccordionContent className="bg-background">
                {module.lessons.map((lesson: any, lessonIndex: number) =>
                  lesson.id === lessonId ? (
                    <div
                      key={lesson.id}
                      className="flex items-center gap-3 py-2 px-4 bg-secondary text-secondary-foreground"
                    >
                      ...
                      <div className="flex-1 text-left">
                        ...
                        <div className="text-xs text-secondary-foreground/80 mt-1 flex items-center gap-2">
